...
1. **全球科技要闻速递**：马斯克/特朗普、AI、商业航天、产业链涨价、国内科技等
2. **硬件上游原材料价格动态**：碳酸锂、六氟磷酸锂、MLCC、光纤、磷化铟、铜箔、液冷剂等（表格 + 资讯价提取）
3. **全球主要股市科技板块表现**：日本、韩国、美国指数与科技个股

本地运行后会在 `reports/Tech_Upstream_Morning_Report_YYYYMMDD.md` 生成 Markdown 晨报。
